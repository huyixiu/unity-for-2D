...
public class UIBasePanel : MonoBehaviour
{
    ...
    public UIPanelID beforeID = UIPanelID.ID_None;
    public UIShowMode showMode = UIShowMode.M_Nothing;

    //用于设置UIPanel始终在前面的C#属性
    protected bool _isAlwaysAbove = false;
    public bool IsAlwaysAbove
    {
        get { return _isAlwaysAbove; }
        set { _isAlwaysAbove = value; }
    }
    ...
    {
        this.gameObject.SetActive(true);//直接显示
    }
